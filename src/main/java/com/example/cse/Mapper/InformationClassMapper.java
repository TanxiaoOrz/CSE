...
public interface InformationClassMapper {
    ...
    List<InformationClass> getInformationClassByRule(@Param("Cid") Integer cid,
            @Param("RelativeMessage") Integer relativeMessage, @Param("RelativeLocation") Integer lid);
    ...
    @Select("select Lists ferom information_class_echarts where Cid = #{Cid}")
    String getEchartData(@Param("Cid") Integer cid);

    @Select("select StartYear ferom information_class_echarts where Cid = #{Cid}")
    Integer getEchartStartYear(@Param("Cid") Integer cid);
