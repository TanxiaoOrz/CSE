...
public class LocationController {
    ...
    public Vo<LocationDto> getLocation(@PathVariable Integer id,
            @RequestParam(required = false) Integer informationLimit,
            @RequestParam(required = false) Integer messageLimit,
            @RequestParam(required = false) Integer informationMessageLimit, HttpServletRequest request)
            throws WrongDataException {
        UserDto userDto = (UserDto) request.getAttribute("UserDto");
        LocationDto locationDto = locationService.getLocation(id, userDto, informationLimit, messageLimit,
                informationMessageLimit);
    ...
    public Vo<List<LocationDto>> getLocations(@RequestParam Integer informationLimit,
        ...
        returns = locationService.getLocationsShow(userDto, locationLimit, informationLimit, messageLimit,
                informationMessageLimit);
